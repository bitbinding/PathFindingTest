...
#include "../../PathFindingTest/tracedialog.h"
...
struct qt_meta_stringdata_TraceDialog_t {
    QByteArrayData data[1];
    char stringdata[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TraceDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TraceDialog_t qt_meta_stringdata_TraceDialog = {
    {
QT_MOC_LITERAL(0, 0, 11) // "TraceDialog"
...
const QMetaObject TraceDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TraceDialog.data,
      qt_meta_data_TraceDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TraceDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TraceDialog.stringdata))
